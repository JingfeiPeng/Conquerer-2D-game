            ...
            if pygame.mouse.get_pressed() == (1, 0, 0):
                ...
                if mouse[1] > 600:
                    if mouse[0] > 0 and mouse[0] < 225:
                        ...
                        attack, health, mobility, gold, scorePoint, interface = menu(attack, health, mobility, gold,
                                                                                     scorePoint)
                    ...
                    # handle if gameguide is clicked
                        ...
                        attack, health, mobility, gold, scorePoint = labratory(attack, health, mobility, gold,
                                                                               scorePoint)
